...
- Invokes `speckit.[command]` via the Skill tool (e.g., `Skill(speckit.specify)`)
...
- **Prerequisite**: spec-kit skills must be installed in the target project (see [spec-kit installation](https://github.com/github/spec-kit))
