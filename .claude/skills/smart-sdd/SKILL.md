...
> **⚠️ Known pitfalls**: See [`lessons-learned.md`](../../../lessons-learned.md) for 20 gap patterns + 66 specific lessons from real pipeline runs. Consult when hitting unexpected agent behavior.
>
