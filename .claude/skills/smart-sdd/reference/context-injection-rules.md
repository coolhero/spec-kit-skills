...
| `ui-flows.md` | absent | Skip UI Flow Spec injection for plan/implement/verify. Agent uses FR/SC descriptions directly for UI implementation. Note in Checkpoint: "No UI Flow Specs — implementing from FR/SC only" |
