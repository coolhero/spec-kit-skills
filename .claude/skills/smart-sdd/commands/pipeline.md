...
5. **Entity Ownership Conflict Gate**: Before showing Review options, check for entity ownership conflicts:
...
7. **Catch-all**: If this response ends without AskUserQuestion (for ANY reason), you MUST show: `✅ speckit-plan executed for [FID] - [Feature Name].\n💡 Type "continue" to review the results.` — Do NOT end silently. Do NOT skip to tasks.
