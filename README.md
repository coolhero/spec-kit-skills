...
[한국어 README](README.ko.md) | [Playwright Setup Guide](PLAYWRIGHT-GUIDE.md) | [Lessons Learned](lessons-learned.md) | Last updated: 2026-03-18 15:09 KST
...
| Failure patterns & countermeasures | [`lessons-learned.md`](lessons-learned.md) — 19 gap patterns + 36 specific lessons from real pipeline executions. Useful for anyone building AI agent pipelines. |
...
| `lessons-learned.md` | AI agent pipeline failure patterns (G1–G19) and specific lessons (L1–L36) — universal takeaways for agent skill builders |
