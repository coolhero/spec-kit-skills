...
[English README](README.md) | [MCP 설정 가이드](MCP-GUIDE.md) | Last updated: 2026-03-08 09:02 KST
...
- (선택) [Playwright MCP](https://github.com/microsoft/playwright-mcp) 런타임 UI 검증용 — **[MCP 설정 가이드](MCP-GUIDE.md)** 참고
