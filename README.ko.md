...
[English README](README.md) | [MCP 설정 가이드](MCP-GUIDE.md) | Last updated: 2026-03-08 16:28 KST
...
<details>
<summary><h2>📖 /reverse-spec — 상세 워크플로우</h2></summary>
...
<details>
<summary><h2>📖 /smart-sdd — 상세 워크플로우</h2></summary>
...
# 파이프라인
/smart-sdd pipeline                      # 단계별 확인 포함
/smart-sdd pipeline --from ./path        # 지정 경로에서 아티펙트 읽기
/smart-sdd pipeline --start implement    # implement 단계부터 시작
/smart-sdd pipeline --start verify       # verify 단계부터 시작

# 단계별 실행
/smart-sdd constitution                  # Constitution 확정
/smart-sdd specify F001                  # Feature 명세
/smart-sdd plan F001                     # Feature 계획
/smart-sdd tasks F001                    # 태스크 생성
/smart-sdd analyze F001                  # 교차 산출물 일관성 검사
/smart-sdd implement F001               # Feature 구현
/smart-sdd verify F001                   # Feature 검증

# 관리
/smart-sdd restructure                   # Feature 분할, 병합, 이동, 순서 변경, 삭제
...
<details>
<summary><h2>📖 End-to-End 워크플로우 예시</h2></summary>
