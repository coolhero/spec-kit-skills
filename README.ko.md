...
[English README](README.md) | [Playwright 설정 가이드](PLAYWRIGHT-GUIDE.md) | [Lessons Learned](lessons-learned.md) | Last updated: 2026-03-16 18:15 KST
...
> **요약**: spec-kit-skills는 에이전트의 지능을 대체하지 않고 **harness**합니다. 에이전트가 창의적 작업을 하고, harness가 그 작업이 올바른 정보에 기반하고, 검증을 거쳤으며, 목표에 충실하도록 보장합니다.
