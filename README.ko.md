...
| 결정 이력 | `history.md` |
| 실패 패턴 & 대응책 | [`lessons-learned.md`](lessons-learned.md) — 19개 갭 패턴 + 40개 구체적 교훈. AI 에이전트 파이프라인을 설계하는 누구에게나 유용합니다. |
...
| `lessons-learned.md` | AI 에이전트 파이프라인 실패 패턴(G1–G19)과 구체적 교훈(L1–L40) — 에이전트 스킬 설계자를 위한 범용 takeaway |
