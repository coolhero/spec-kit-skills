...
[English README](README.md) | [MCP 설정 가이드](MCP-GUIDE.md) | Last updated: 2026-03-08 14:48 KST
...
- [Playwright MCP](https://github.com/microsoft/playwright-mcp) 런타임 UI 탐색 및 검증용 — `claude mcp add --scope user playwright -- npx @playwright/mcp@latest` — Electron CDP 설정 및 트러블슈팅은 **[MCP 설정 가이드](MCP-GUIDE.md)** 참고
