...
Building spec-kit-skills took over 500 commits across three weeks. We cataloged 20 recurring failure patterns and 70 specific lessons. Every single one came from a real pipeline run that produced wrong results.
...
The repository includes 38 user-facing scenarios in SCENARIO-CATALOG.md and a comprehensive lessons-learned file with all 20 patterns and 70 specific lessons.
