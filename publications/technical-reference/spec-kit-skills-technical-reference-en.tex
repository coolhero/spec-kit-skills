...
\section{Velocity Override --- The Sixth Evasion Pattern}

Discovered during the AEGIS case study (2026-03-25), this pattern occurs when the user's urgency request (``do everything,'' ``just finish it,'' ``auto-approve all'') gives the agent implicit permission to bypass quality gates. Unlike the five patterns above which stem from context compression, Velocity Override is \textbf{user-authorized degradation}---the agent has a legitimate-sounding reason to skip steps.
