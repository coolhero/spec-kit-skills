...
The module system is the theory. Part~V is the practice---20~gap patterns and 67~specific lessons discovered through hundreds of real pipeline runs. If Parts~II--IV explained \emph{how the system is designed}, Part~V explains \emph{why each design decision was made}---through the failures that motivated them.
