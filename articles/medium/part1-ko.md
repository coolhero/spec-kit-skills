...
**요약**: AI 코딩 에이전트는 놀랍도록 유능하지만, "유능한 것"과 "통제 가능한 것"은 다른 문제입니다. 이 시리즈는 **spec-kit-skills**를 소개합니다 — AI 에이전트가 코드를 탐색하고, 설계하고, 구현하는 전 과정을 개발자가 구조적으로 통제할 수 있게 해주는 오픈소스 Claude Code 스킬 세트입니다.
